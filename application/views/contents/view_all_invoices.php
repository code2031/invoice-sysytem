    ...
    <div class="card m-b-20">
        <div class="card-block">
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody> 
                 <?php foreach ($invoice_detail as $value) { ?>
                <tr>
                ...
                href="<?php echo site_url('admin_controller/display_single_invoice/'.$value->invoice_id) ;?>" data-original-title="Details"><i class="mdi mdi-receipt alert-success"></i></a> 
                |
                <a title="" data-placement="top" data-toggle="tooltip" class="tooltips" 
